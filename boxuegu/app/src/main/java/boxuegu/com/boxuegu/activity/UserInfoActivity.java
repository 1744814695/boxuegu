...
public class UserInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final int CHANGE_NIVKNAME=1; //修改昵称的自定义常量
    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.rl_nickName:  //昵称的点击事件
                ...
                enterActivityForResult(ChangeUserInfoActivity.class,CHANGE_NIVKNAME,bdName);
                //跳转到个人资料修改界面
                break;
            ...
            case R.id.rl_signature:  //签名的点击事件
                ...
                enterActivityForResult(ChangeUserInfoActivity.class,CHANGE_NIVKNAME,bdSignature);
                //跳转到个人资料修改界面
                break;
            default:
                break;
    ...
    protected void onActivityResult(int requestCode,int resultCode,Intent data){
        ...
        switch (requestCode){
            case CHANGE_NIVKNAME: //个人资料修改界面回传过来的昵称数据
                if (data!=null){
